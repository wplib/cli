...
/**
 * Namespace WPLib_CLI\Generators
 */
namespace WPLib_CLI\Generate\Generators {
	 ...
	 */
	class App extends Base\Generator {

		const SLUG = Objects\App::SLUG;
		...
		function register() {
			...
			/**
			 * Call Traits\Module_Directories->register_module_directories()
			...
			$this->register_generator( 'post-types', $this->object->post_types, array(
				'element_slug'  => Objects\Post_Type::SLUG,
			));

			$this->register_generator( 'taxonomies', $this->object->taxonomies, array(
				'element_slug'  => Objects\Taxonomy::SLUG,
			));
